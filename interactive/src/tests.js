...
import { nds,nds_board, getLayer, getAbsoluteLocalParent, atachedToAnything, getParents } from './hardware.js';
...
(async () => {
    ...
    function piece_pointer_feedback_start() {
        mouseOverLayer = this;
        if (this.tool_needed == tools.selected || !atachedToAnything(this.id,hardware)) {
