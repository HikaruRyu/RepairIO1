...
import { nds_bottom_btns, ds_btns_front_ds, nds_board,top_1, getLayer, getAbsoluteLocalParent, atachedToAnything, getParents } from './hardware.js';
...
(async () => {
    ...
    var hardware = ds_btns_front_ds.hardware[ds_btns_front_ds.current];
    ...
    function scene_change() {
        console.log(ds_btns_front_ds.conditions[ds_btns_front_ds.current])
        console.log(getLayer(2,hardware))
        if (ds_btns_front_ds.current + 1 == ds_btns_front_ds.hardware.length) {
            window.location.reload();
        }
        if (ds_btns_front_ds.conditions[ds_btns_front_ds.current]()) {
            ds_btns_front_ds.current += 1;
            ...
            dragTarget = null;
            dragLayer = null;
            hardware = ds_btns_front_ds.hardware[ds_btns_front_ds.current];
            instanciate_hardware(hardware);
            app.stage.addChild(ds_btns_front_ds.texts[ds_btns_front_ds.current -1]).destroy();
    ...
    app.ticker.add((delta) => {
        if (ds_btns_front_ds.current == ds_btns_front_ds.conditions.length || !ds_btns_front_ds.conditions[ds_btns_front_ds.current]()) {
            button_spr.texture = btnoff_t
        } else if(ds_btns_front_ds.conditions[ds_btns_front_ds.current]()) {
    ...
    function instanciate_hardware(hardware) {
        ...
        hardware.layers.forEach(element => {
            ...
            if (element.state == 1) {
                ...
                ds_btns_front_ds.texts[ds_btns_front_ds.current].x = 800;
                ds_btns_front_ds.texts[ds_btns_front_ds.current].style = style;
                app.stage.addChild(ds_btns_front_ds.texts[ds_btns_front_ds.current]);
